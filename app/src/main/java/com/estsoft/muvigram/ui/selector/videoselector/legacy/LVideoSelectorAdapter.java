...
import com.estsoft.muvigram.ui.selector.videoselector.ThumbnailImageView;
...
public class LVideoSelectorAdapter extends RecyclerView.Adapter<LVideoSelectorAdapter.ViewHolder> implements LVideoSelectorAdapterContract.View, LVideoSelectorAdapterContract.Model {
    ...
    @Override
    public void setOnClickListener(com.estsoft.muvigram.ui.selector.videoselector.VideoSelectorAdapter.OnItemClickListener clickListener) {
