...
package com.estsoft.muvigram.transcoder.eglsurface;
...
class TextureRender {
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            Timber.d("Could not compile shader %d", shaderType);
            Timber.d("%s", GLES20.glGetShaderInfoLog(shader));
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            ...
            Timber.e("%s", GLES20.glGetProgramInfoLog(program));
