...
public class CircularProgressBar extends View {
    ...
    private int foreColor = Color.CYAN;
    private RectF rectF;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            backColor = typedArray.getInt(R.styleable.CircleProgressBar_progressbarColor, backColor);
        ...
        backgroundPaint.setColor(adjustAlpha(backColor, 0.3f));
        backgroundPaint.setStyle(Paint.Style.STROKE);
        backgroundPaint.setStrokeWidth(strokeWidth);

        foregroundPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        foregroundPaint.setColor(adjustAlpha(foreColor, 0.8f));
